$(document).ready(function () {
    ...
    $(document).on('click', '.add-new__save', function (e) {
        e.preventDefault()
        ...
        if (document.querySelector('#author_name')) {
            author_name = document.querySelector('#author_name').value
        }

        if ($('#category_id li.active')) {
            category_id = $('#category_id li.active').attr('data-id')
        }

        if ($('#status li.active')) {
            status = $('#status li.active').attr('data-id')
        }
